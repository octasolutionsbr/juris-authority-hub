...
const Header = () => {
  ...
  const navLinks = [
    { label: t("header.areas"), href: "/#areas-de-atuacao", isAnchor: true },
              ...
              {navLinks.map((link) => (
                link.isAnchor ? (
                  <a
                    ...
                    href={link.href}
                    onClick={(e) => handleAnchorClick(e, link.href)}
                    className="text-sm font-medium transition-colors hover:text-primary px-4 py-2 text-foreground/80 cursor-pointer"
                  >
                    {link.label}
                  </a>
                ) : (
