                  ...
                  <div className="space-y-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4 group">
                        ...
                        <div>
                          <h2 className="font-semibold text-foreground mb-2 text-lg">{t("contact.info.email")}</h2>
                          <a
                      ...
                      <div className="flex items-start gap-4 group">
                        ...
                        <div>
                          <h2 className="font-semibold text-foreground mb-2 text-lg">{t("contact.info.phone")}</h2>
                          <a
                      ...
                      <div className="flex items-start gap-4 group">
                        ...
                        <div>
                          <h2 className="font-semibold text-foreground mb-2 text-lg">{t("contact.info.address")}</h2>
                          <address className="text-muted-foreground leading-relaxed whitespace-pre-line not-italic">
                      ...
                      <div className="flex items-start gap-4 group">
                        ...
                        <div>
                          <h2 className="font-semibold text-foreground mb-2 text-lg">{t("contact.info.hours")}</h2>
